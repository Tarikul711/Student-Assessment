...
if (isset($_POST['submit'])) {
    ...
    $dates = date("Y/m/d");
    try {
        if (empty($assessment_name) || empty($faculty_name) || empty($batch_number) || empty($session) || empty($sub_date)) {
...
//          batch_number='$batch_number' AND sessions='$session'");
        ...
        $result = mysql_query("INSERT INTO assesment (ass_name,facultyName,batch_number,sessions,dates,duDate)
VALUES ('$assessment_name','$faculty_name','$batch_number','$session','$dates','$sub_date')");
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    ...
                                    <li><a href="login_2.php">Login Page</a></li>
                ...
                <div class="sidebar-footer hidden-small">
                    ...
                    <a data-toggle="tooltip" data-placement="top" title="Logout" href="login_2.php">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                ...
                                <li><a href="login_2.php"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                            </ul>
                        </li>
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="demo-form2" enctype="multipart/form-data" action="" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5 col-sm-5 col-xs-10">
                                                <input type="text" id="title" name="faculty_name" required="required"
                                                       class="form-control col-md-4 col-xs-8">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="title">Submission
                                                Last Date <span class="required">*</span>
                                            </label>
                                            <div class="col-md-5 col-sm-5 col-xs-10">
                                                <input type="date" id="title" name="sub_date" required="required"
                                                       class="form-control col-md-4 col-xs-8">
                                            </div>
                                        </div>

                                ...
                                <div class="col-sm-12">
                                    <table id="datatable-responsive"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                rowspan="1" colspan="1"
                                                aria-label="Position: activate to sort column ascending">Number OF Student
                                            </th>
                                            <!--                                            <th class="sorting" tabindex="0" aria-controls="datatable-responsive"-->
                                            <!--                                                rowspan="1" colspan="1"-->
                                        ...
                                        if (isset($_POST['submit'])) {
                                            ...
                                            $checkValue = "tarikul";
                                            $query = mysql_query("SELECT COUNT(student_email) FROM ecclaim,assesment WHERE ecclaim.assessment_Id=assesment.id AND facultyName='$facultyName' AND assesment.sessions='$academin_year' GROUP BY student_email");
//                                            var_dump("SELECT COUNT(student_email) FROM ecclaim,assesment WHERE ecclaim.assessment_Id=assesment.id AND facultyName='$facultyName' AND assesment.sessions='$academin_year' GROUP BY student_email");
...
//                                        }
                                    ...
                                    if ($checkValue != null) {
                                        ...
                                        <div id="population_chart" data-sort="false" data-width="800"
                                             ...
                                             name="Number of students making a claim">
                                            <div class="define-chart-row" data-color="#84d6ff"
                                                 title="Students"><?php echo $result[0] ?></div>

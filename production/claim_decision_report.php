                                ...
                                <div class="col-sm-12">
                                    <table id="datatable-responsive"
                                        ...
                                        <tr role="row">
                                            ...
                                            <!--                                            <th class="sorting" tabindex="0" aria-controls="datatable-responsive"-->
                                            <!--                                                rowspan="1" colspan="1"-->
                                            <!--                                                aria-label="Position: activate to sort column ascending">Completed Claim-->
                                            <!--                                            </th>-->
                                            <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                rowspan="1" colspan="1"
                                                aria-label="Position: activate to sort column ascending">Total Claim
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                rowspan="1" colspan="1"
                                                aria-label="Position: activate to sort column ascending">Without
                                                Decision
                                            </th>
                                            <!--                                            <th class="sorting" tabindex="0" aria-controls="datatable-responsive"-->
                                            <!--                                                rowspan="1" colspan="1"-->
...
//                                            $result1 = mysql_fetch_array($complete_query);
                                            ...
                                            $complete_query2 = mysql_query("SELECT COUNT(ec_id) FROM ecclaim,assesment WHERE ecclaim.assessment_Id=assesment.id AND facultyName='$facultyName' AND assesment.sessions='$academin_year' AND processing_status='InProcess'");
//                                           var_dump("SELECT COUNT(ec_id) FROM ecclaim,assesment WHERE ecclaim.assessment_Id=assesment.id AND facultyName='$facultyName' AND assesment.sessions='$academin_year' AND processing_status='InProcess'");
...
//                                        }
                                            ...
                                            <tr role="row" class="even">
                                                ...
                                                <td class="bg-primary"><?php echo $result[0]; ?></td>
                                                <td class="bg-danger"><?php echo $result2[0]; ?></td>
                                            </tr>
                                    ...
                                    <div id="population_chart" data-sort="false" data-width="800"
                                        ...
                                        <div class="define-chart-row" data-color="#38BCFF"
                                             title="Without Decision"><?php echo $result2[0] ?></div>

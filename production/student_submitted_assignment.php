                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-fixed-header" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <?php
                                    $result = mysql_query("SELECT * FROM assignment WHERE student_email='$student_email'");
                                    $counter = 0;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-xs"
                                                   href="student_assignment_details.php?id=<?php echo $rows['ass_id']; ?>"><i
                                                ...
                                                if ($now <= $lastDate) {
                                                    ...
                                                    <a class="btn btn-info btn-xs"
                                                       href="student_assignment_edit.php?id=<?php echo $rows['ass_id']; ?>"><i

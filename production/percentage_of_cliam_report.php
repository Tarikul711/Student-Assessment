                                ...
                                <div class="col-sm-12">
                                    <table id="datatable-responsive"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                rowspan="1" colspan="1"
                                                aria-label="Position: activate to sort column ascending">InCompleted
                                                Claim
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                rowspan="1" colspan="1"
...
//                                        }
                                            ...
                                            <tr role="row" class="even">
                                                ...
                                                <td tabindex="0" class="sorting_1">Business</td>
                                                <td class="bg-success"><?php echo $result1[0]; ?></td>
                                    ...
                                    <div id="population_chart" data-sort="false" data-width="800"
                                        ...
                                        <div class="define-chart-row" data-color="#84d6ff"
                                             title="Completed"><?php echo $result1[0] ?></div>
                                        <div class="define-chart-row" data-color="#38BCFF"
                                             title="In Completed"><?php echo $result2[0] ?></div>
                                        <div class="define-chart-row" data-color="#00A9FF"
                                             title="Total"><?php echo $result[0] ?></div>
